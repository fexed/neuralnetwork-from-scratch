...
def test_MONK(monk=1, output=True, initialization="normalized_xavier"):
    ...
    if (output):
        net.summary()
    history, val_history, epochs_done = net.training_loop(xtr, ytr, X_validation=xvl, Y_validation=yvl, epochs=1000, learning_rate=0.01, verbose=output, early_stopping=25)
