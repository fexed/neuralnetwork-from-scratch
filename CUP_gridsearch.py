...
res = grid_search(10, 2, X, Y, layers=[0], units=list(range(21, 25, 1)), learning_rates=[0.00125, 0.001, 0.000625], batch_sizes=[1], init_functions=["normalized_xavier"], momentums=[0], regularizators=[None, L2(l = 1e-4), L2(l = 1e-5)], dropouts=[0], nesterovs=[0], epochs=1500, verbose=False, early_stopping=150)
