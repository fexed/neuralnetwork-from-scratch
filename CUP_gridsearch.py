...
res = grid_search(10, 2, xtr, ytr, X_validation=xvl, Y_validation=yvl, layers=list(range(1, 3)), units=list(range(5, 21, 5)), learning_rates=[1e-4, 1e-5, 1e-6], batch_sizes=[1], init_functions=["normalized_xavier"], momentums=[0, 0.8], regularizators=[L2(l = 0.001), L2(l = 0.0001), L2(l = 0.00001)], epochs=1000, verbose=False, early_stopping=150)
