...
res = grid_search(10, 1, xtr, ytr, X_validation=xvl, Y_validation=yvl, layers=[2], units=list(range(20, 35)), learning_rates=[0.001], batch_sizes=[1], init_functions=["normalized_xavier"], momentums=[0, 0.8], regularizators=[None, L2(l = 0.005)], epochs=1000, verbose=False, early_stopping=25)
