...
def test_CUP(output=True):
    ...
    history, val_history, accuracy_history = net.training_loop(xtr, ytr, X_validation=xvl, Y_validation=yvl, epochs=300, learning_rate=0.001, verbose=output, batch_size=1, metric = Accuracy())
