...
\author{\small{Authors (\textit{Sergio Latrofa, Federico Matteoni, Riccardo Parente}).} \\ % put your full name here
        \small{Master Degree in Artificial Intelligence.}\\ \small{\underline{s.latrofa@studenti.unipi.it}, \underline{f.matteoni4@studenti.unipi.it}, \underline{r.parente@studenti.unipi.it}} \\  % put your Master Degree (and curriculum) here
        \small{Machine Learning course (654AA), Academic Year: 2021/22} \\
        \small{Date: xx/yy/2022} \\
        \small{Type of project: \textbf{A with ML}}
}
...
\noindent\fbox{%
    \parbox{\textwidth}{%
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item Pages: up to \textbf{8} [2 students case], up to \textbf{10} pages for 3 students project [standard case]: use appendix for large or other tables or plots (if needed); \underline{the pages out of the limit will be not read nor evaluated}!!! $\leftarrow$ Important
